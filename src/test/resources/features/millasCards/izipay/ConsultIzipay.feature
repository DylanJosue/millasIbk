@ConsultMillasCards
Feature: Consultar saldo de millas con tarjeta - IZIPAY

  @Automated @Happy_path @CONSULT_IZIPAY
...
#      | 422224******1552 | 200    | 1            | 50501822       | 0060102625 | OK      |  IZIPAY   |
#
#    #4110905020038781
#    Examples: TC Visa Signature
#      | cardNumber       | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
#      | 411090******8781 | 200    | 1            | 50502464       | 0060103262 | OK      |IZIPAY   |
#
#    #5491610370036163
#    Examples: TC Mastercard Platinum
#      | cardNumber       | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
#      | 549161******6163 | 200    | 1            | 50502307       | 0060103106 | OK      |IZIPAY   |
#
#    #5444021730057295
#    Examples: TC Mastercard Clasica
#      | cardNumber       | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
#      | 544402******7295 | 200    | 1            | 50502319       | 0060104326 | OK      |IZIPAY   |
#
#    #377754800113265
#    Examples: TC Amex - American Express® Black
#      | cardNumber      | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
#      | 377754*****3265 | 200    | 1            | 50501730       | 0060102533 | OK      |IZIPAY   |
#
#    #377753002480589
#    Examples: TC Amex - American Express®
#      | cardNumber      | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
#      | 377753*****0589 | 200    | 1            | 50501739       | 0060102542 | OK      |IZIPAY   |
#
#    #377754000353299
#    Examples: TC Amex - American Express® Blue
#      | cardNumber      | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
#      | 377754*****3299 | 200    | 1            | 50501742       | 0060102545 | OK      |IZIPAY   |
#
#    #4110740057040115
#    Examples: TD Débito
#      | cardNumber       | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
#      | 411074******0115 | 200    | 1            | 50501625       | 0060102433 | OK      |IZIPAY   |
#
#    #4110740057000101
#    Examples: TD Joven
#      | cardNumber       | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
#      | 411074******0101 | 200    | 1            | 50501639       | 0060102445 | OK      |IZIPAY   |

    #4110740000077511
    Examples: TD Cuenta corriente
      | cardNumber       | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
      | 411074******7511 | 200    | 1            | 08819568       | 0060047641 | OK      |IZIPAY   |

    #377754498001731
    Examples: TC American Express® Blue - PASAPORTE
      | cardNumber      | codigo | documentType | documentNumber | codUnico   | mensaje |cliente|
      | 377754*****1731 | 200    | 5            | AD100005       | 0060106731 | OK      |IZIPAY   |

    #377753998003106
    Examples: TC American Express® Gold - PASAPORTE
      | cardNumber      | codigo | documentType | documentNumber | codUnico   | mensaje | cliente |
      | 377753*****3106 | 200    | 5            | AD100004       | 0060106724 | OK      | IZIPAY  |

    #4222240057015394
    Examples: TC Visa Platinum - Carné de extranjería
      | cardNumber       | codigo | documentType | documentNumber | codUnico   | mensaje | cliente |
      | 422224******5394 | 200    | 3            | CE277062       | 0060538904 | OK      | IZIPAY  |

  @Automated @Unhappy_path @CONSULT_IZIPAY
  Scenario Outline:[UNHAPPY PATH] Consultar saldo de millas con tarjeta débito e incorrecto número de documento
    ...
    Examples: TD Débito
      ...
      | 411074******0115 | 403    | 1            | 50501822       | TARJETA DE DEBITO NO EXISTE |IZIPAY   |

    #4222240010041552
    Examples: TC Visa Platinum
      | cardNumber       | codigo | documentType | documentNumber | mensaje                      |cliente|
      | 422224******1552 | 403    | 1            | 50502464       | TARJETA DE CREDITO NO EXISTE |IZIPAY   |
  ...
  Scenario Outline:[UNHAPPY PATH] Consultar saldo de millas con tarjeta en plano
    ...
    Examples: TC Visa Oro
      | cardNumber       | codigo | documentType | documentNumber | mensaje                            |cliente|
      | 4222240010041552 | 403    | 1            | 50501822       | REVISAR FORMATO TARJETA ENCRIPTADA |IZIPAY   |
  ...
  Scenario Outline:[UNHAPPY PATH] Consultar saldo de millas tarjetas que no participan en el programa
    ...
    Examples: Tarjeta Premia
      | cardNumber       | codigo | documentType | documentNumber | mensaje                                                                    |cliente|
      | 411093******9241 | 403    | 1            | 45619220       | LA TARJETA NO PARTICIPA EN EL PROGRAMA DE BENEFICIOS Y/O NO ACUMULA MILLAS | IZIPAY   |
  ...
  Scenario Outline: [UNHAPPY PATH] Consulta saldo de millas con tarjeta cuenta de baja y cuenta bloqueada
    ...
    Examples: TC Visa Platinum - DNI
      | cardNumber       | codigo | documentType | documentNumber | mensaje             |cliente|
      | 422224******2006 | 403    | 1            | 50502452       | CUENTA DADA DE BAJA |IZIPAY   |

    #377754000353281
    Examples: TC American Express® Blue - DNI
      | cardNumber      | codigo | documentType | documentNumber | mensaje             |cliente|
      | 377754*****3281 | 403    | 1            | 50501728       | CUENTA DADA DE BAJA |IZIPAY   |

    #5443590450043678
#    Examples: TC Mastercard Oro
#      | cardNumber       | codigo | documentType | documentNumber | mensaje          |cliente|
#      | 544359******3678 | 403    | 1            | 50502306       | CUENTA BLOQUEADA |IZIPAY   |

    #377754500179681
    Examples: TC Amex - American Express® Platinum
      | cardNumber      | codigo | documentType | documentNumber | mensaje          |cliente|
      | 377754*****9681 | 403    | 1            | 50501743       | CUENTA BLOQUEADA |IZIPAY   |

    #377752610032360
    Examples: TC Amex - The Platinum Card®
      | cardNumber      | codigo | documentType | documentNumber | mensaje          |cliente|
      | 377752*****2360 | 403    | 1            | 50501741       | CUENTA DADA DE BAJA |IZIPAY   |

    #4913370720094965
    Examples: TC Visa Oro - CE
      | cardNumber       | codigo | documentType | documentNumber | mensaje          |cliente|
      | 491337******4965 | 403    | 3            | CE100002       | CUENTA BLOQUEADA |IZIPAY   |
  ...
  Scenario Outline: [UNHAPPY PATH] Consultar millas con numero de tarjeta valor no existe
    ...
    Examples: Numero de tarjeta valor no existe
      | cardNumber       | codigo | documentType | documentNumber | mensaje                      |cliente|
      | 432325******3525 | 403    | 1            | 50501728       | TARJETA DE CREDITO NO EXISTE |IZIPAY   |
  ...
  #41107400000775123655
    Examples: Ingresa numero de tarjeta valor incorrecto
      | cardNumber           | codigo | documentType | documentNumber | mensaje                            |cliente|
      | 411074000******23655 | 403    | 1            | 50501728       | REVISAR FORMATO TARJETA ENCRIPTADA |IZIPAY   |
  ...
  Scenario Outline: [UNHAPPY PATH] Valida consultar millas error servicio de tarjeta
    ...
    Examples: ERROR SERVICIO DE TARJETA
      | cardNumber        | codigo | documentType | documentNumber | mensaje                            |cliente|
      | 491337*******3023 | 403    | 1            | 50501728       | REVISAR FORMATO TARJETA ENCRIPTADA |IZIPAY   |
  ...
  Scenario Outline: [UNHAPPY PATH] Valida consultar ingresando valores vacios e valores incorrectos
    ...
    Examples: Ingresando numero tarjeta con valor Null
      | cardNumber | codigo | documentType | documentNumber | mensaje            |cliente|
      |            | 404    | 1            | 50501728       | Resource not found |IZIPAY   |

    Examples: Ingresando tipo documento con valor Null
      | cardNumber       | codigo | documentType | documentNumber | mensaje                           |cliente|
      | 422224******1552 | 403    |              | 50502464       | ERROR EN TIPO/NUMERO DE DOCUMENTO |IZIPAY   |

    Examples: Ingresando numero documento con valor Null
      | cardNumber       | codigo | documentType | documentNumber | mensaje                           |cliente|
      | 422224******1552 | 403    | 1            |                | ERROR EN TIPO/NUMERO DE DOCUMENTO |IZIPAY   |

    Examples: Ingresando tipo documento no correspondiente al numero de documento - TC
      | cardNumber       | codigo | documentType | documentNumber | mensaje                        |cliente|
      | 422224******1552 | 403    | 2            | 50502464       | ERROR EN DATOS DE ENTRADA A TC |IZIPAY   |

    Examples: Ingresando tipo documento no correspondiente al numero de documento - TD
      | cardNumber       | codigo | documentType | documentNumber | mensaje                        |cliente|
      | 411074******0115 | 403    | 2            | 50501625       | ERROR EN DATOS DE ENTRADA A TD |IZIPAY   |
  ...
  Scenario Outline: [UNHAPPY PATH] Consultar saldo de millas de tarjetas sin enviar orderNumber
    ...
    Examples: TC Visa Platinum
      | cardNumber       | codigo | documentType | documentNumber | mensaje                                    |cliente|
      | 422224******1552 | 403    | 1            | 50501822       | El campo orderNumber debe ser obligatorio. |IZIPAY   |
  ...
  Scenario Outline: [UNHAPPY PATH] Consultar saldo de millas de tarjetas con enviar orderNumber mas de 50 caracteres
    ...
    Examples: TC Visa Platinum
      | cardNumber       | codigo | documentType | documentNumber | mensaje                                                            |cliente|
      | 422224******1552 | 403    | 1            | 50501822       | El campo orderNumber debe tener un tamaño máximo de 50 caracteres. |IZIPAY   |
  ...
  Scenario Outline: [UNHAPPY PATH] Consultar saldo de millas de tarjetas en ambiente caido
    ...
    Examples: TC Visa Platinum
      | cardNumber       | codigo | documentType | documentNumber | mensaje                                                      |cliente|
      | 422224******1552 | 500    | 1            | 50501822       | Lo sentimos, algo salió mal, por favor inténtalo nuevamente. |IZIPAY   |