...
public class CanjeMillasQuestions {
    ...
    public static Question<String> responseNetMillas() {
        return Question.about("Mensaje de las millas")
                .answeredBy(
                        actor -> SerenityRest.lastResponse().jsonPath().getString("response.mile.netMiles")
                );
    }
