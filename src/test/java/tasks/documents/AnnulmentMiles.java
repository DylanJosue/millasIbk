...
public class AnnulmentMiles implements Task {
    ...
    public AnnulmentMiles(String accessToken, String cliente,String authorizationCode, String orderNumber, String operationDate) {
    ...
    public static Performable annulmentMiles(String accessToken, String cliente,String authorizationCode,String orderNumber,String operationDate) {
        return Tasks.instrumented(AnnulmentMiles.class,accessToken,cliente,authorizationCode, orderNumber,operationDate);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Put.to(WebServiceEndPoints.API_ANNULMENTMILES_DOCUMENT.getUrl())
